export function countKoreanStroke(이름: string, strict = true): number {
  ...
  for (const 글자 of 이름) {
    ...
    if (charCode >= 가 && charCode <= 힣) {
      ...
      전체획수 += 획수;
    } else if (charCode >= ㄱ && charCode <= ㅎ) {
      const index = charCode - ㄱ;
      전체획수 += 단일자음획수[index];
    } else if (charCode >= ㅏ && charCode <= ㅣ) {
      const index = charCode - ㅏ;
      전체획수 += 모음획수[index];
    }
  }
...
function get받침획수(strict = true) {
  if (strict) {
    return [
      0, 1 /* ㄱ */, 2 /* ㄲ */, 3 /* ㄳ */, 1 /* ㄴ */, 3 /* ㄵ */, 4 /* ㄶ */,
      2 /* ㄷ */, 3 /* ㄹ */, 4 /* ㄺ */, 6 /* ㄻ */, 7 /* ㄼ */, 5 /* ㄽ */,
      6 /* ㄾ */, 7 /* ㄿ */, 6 /* ㅀ */, 3 /* ㅁ */, 4 /* ㅂ */, 6 /* ㅄ */,
...
function get단일자음획수(strict = true) {
  if (strict) {
    return [
      1 /* ㄱ */, 2 /* ㄲ */, 3 /* ㄳ */, 1 /* ㄴ */, 3 /* ㄵ */, 4 /* ㄶ */,
      2 /* ㄷ */, 4 /* ㄸ */, 3 /* ㄹ */, 4 /* ㄺ */, 6 /* ㄻ */, 7 /* ㄼ */,
      5 /* ㄽ */, 6 /* ㄾ */, 7 /* ㄿ */, 6 /* ㅀ */, 3 /* ㅁ */, 4 /* ㅂ */,
      8 /* ㅃ */, 6 /* ㅄ */, 2 /* ㅅ */, 4 /* ㅆ */, 1 /* ㅇ */, 2 /* ㅈ */,
      4 /* ㅉ */, 3 /* ㅊ */, 2 /* ㅋ */, 3 /* ㅌ */, 4 /* ㅍ */, 3 /* ㅎ */,
    ];
  }

  return [
    2 /* ㄱ */, 4 /* ㄲ */, 4 /* ㄳ */, 2 /* ㄴ */, 5 /* ㄵ */, 5 /* ㄶ */,
    3 /* ㄷ */, 6 /* ㄸ */, 5 /* ㄹ */, 7 /* ㄺ */, 9 /* ㄻ */, 9 /* ㄼ */,
    7 /* ㄽ */, 9 /* ㄾ */, 9 /* ㄿ */, 8 /* ㅀ */, 4 /* ㅁ */, 4 /* ㅂ */,
    8 /* ㅃ */, 6 /* ㅄ */, 2 /* ㅅ */, 4 /* ㅆ */, 1 /* ㅇ */, 3 /* ㅈ */,
    6 /* ㅉ */, 4 /* ㅊ */, 3 /* ㅋ */, 4 /* ㅌ */, 4 /* ㅍ */, 3 /* ㅎ */,
  ];
}
